...
![График сл 2 джулия](image/jl2.png){ #fig:005 width=70% }



![Фазовый портрет сл 2 джулия](image/jl2p.png){ #fig:006 width=70% }

Для первого случая в Open Modelica(график и фазовый портрет:

![График сл 2 моделика](image/om2.png){ #fig:007 width=70% }



![Фазовый портрет сл 2 моделика](image/om2p.png){ #fig:008 width=70% }
